...
public interface StabelADT<T> {
	...
	/**
	 * Fjerner et element på toppen av stabelen og returnerer referansen Kaster unntak
	 * EmptyCollectionException hvis stabelen allerede er tom.
	 *
	...
	/**
	 * Returnerer referansen til elementet på toppen av stabelen. Elementet blir ikke fjernet. Kaster unntaket
	 * EmptyCollectionException hvis stabelen allerde er tom.
	 *
