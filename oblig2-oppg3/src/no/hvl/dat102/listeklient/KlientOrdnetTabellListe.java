...
public class KlientOrdnetTabellListe {
	...
	public static void main(String[] args) {
		TabellOrdnetListe<String> navneListe1 = new TabellOrdnetListe<>();
		TabellOrdnetListe<String> navneListe2 = new TabellOrdnetListe<>();
        ...
        while (navneListe1.antall() > 0) {System.out.print(navneListe1.fjernFoerste() + " ");}


		// Skriver ut navnen i avtagende ordning
		System.out.println("\n\nNavnelisten i fallende ordning:");

        while (navneListe2.antall() > 0) {System.out.print(navneListe2.fjernSiste() + " ");}
