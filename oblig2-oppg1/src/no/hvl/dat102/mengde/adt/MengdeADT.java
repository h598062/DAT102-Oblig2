...
public interface MengdeADT<T> extends Iterable<T> {
	...
	/**
	 * Legger til et objekt av klasse T til dette mengde-objektet hvis det ikke fins fra før
	 *
	...
	/**
	 * Oppretter et 'oppramsobjekt' som kan brukes til å gjennomgå alle elementer i mengden etter tur en gang
	 *
